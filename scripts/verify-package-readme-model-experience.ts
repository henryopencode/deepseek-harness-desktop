...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-runtime-update': { kind: 'none', reason: 'Browser-side runtime lifecycle UI; it checks and optionally starts a Host updater without adding model context.' },
