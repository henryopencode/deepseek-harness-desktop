...
export const zh = {
  ...
  phaseCompleted: '更新完成',
  completed: '更新已完成，服务已经重启。点击“重启服务”重新连接到新版本。',
  restart: '重启服务',
  phaseFailed: '更新失败',
...
export const en = {
  ...
  completed: 'The update is complete and the service has restarted. Click “Restart service” to reconnect to the new version.',
